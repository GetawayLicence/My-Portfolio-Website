...
const projects = [
  ...
  },
  {
    ...
    category: "other",
    title: "WokeScroll",
    description: "MVP of mobile application that introduces intuitive features like Vibe Score, share-to-analyze functionality, and fact-check tools that fact-check, emotionally analyze, and score social media posts and news articles in real-time. Built for the hackathon: SummerBuild 2025 (organised by NTU DevHub).", 
